...
-- Existing deployments may already have a legacy restaurants table without owner_user_id.
-- Add the column idempotently; leave legacy rows NULL rather than fabricating ownership.
