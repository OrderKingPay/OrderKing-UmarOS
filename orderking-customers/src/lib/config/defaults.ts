...
export const DEFAULT_CONFIG: PublicAppConfig = {
  brand: {
    ...
    seoTitle: "OrderKing — Food Delivery & KingPay", seoDescription: "Order food from top kitchens with 0% markup and pay seamlessly with KingPay.", ogImageUrl: "/og.jpg", promotionalHeadline: "From local master kitchens to your doorstep.",
  },
